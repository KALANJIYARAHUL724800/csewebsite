...
import { FaEdit, FaEye, FaCertificate, FaTimes } from "react-icons/fa";
...
const ViewCertificates = () => {
	...
	const handleEdit = (certificate) => {
		const locationValue = String(certificate.location || "")
			.trim()
			.toUpperCase();
		...
		setFormData({
			...
			enrollNumber: certificate.enrollNumber ?? "",

			certificateDate: certificate.certificateDate || "",

			institutionName: certificate.institutionName || "CSE COMPUTER EDUCATION",
		...
		setTimeout(() => {
			document.getElementById("certificate-update-form")?.scrollIntoView({
				behavior: "smooth",
				block: "start",
			});
		}, 100);
	...
	const handleUpdate = async (e) => {
		...
		try {
			const response = await updateCertificate(selectedCertificate.id, payload);
	...
	if (loading) {
		return (
			<div className="container py-5 text-center">
				...
				<p className="text-muted mt-3">Loading certificates...</p>
			</div>
		);
	}
		...
		<div className="container-fluid py-4">
				...
				<div
					...
					<div className="card-header bg-primary text-white rounded-top-4">
						<div className="d-flex justify-content-between align-items-center">
							<div>
								<h5 className="fw-bold mb-1">Update Certificate</h5>

								<small>Edit selected certificate details</small>
							</div>
					...
					<div className="card-body p-4">
						<form onSubmit={handleUpdate}>
							<div className="row">
								...
								<div className="col-md-6 mb-3">
									<label className="form-label fw-bold">Certificate Name</label>
								...
								<div className="col-md-6 mb-3">
									<label className="form-label fw-bold">Enroll Number</label>
								...
								<div className="col-md-6 mb-3">
									<label className="form-label fw-bold">Certificate Date</label>
			...
			<div className="card border-0 shadow-sm rounded-4">
				<div className="card-header bg-white border-0 p-3">
					<h5 className="fw-bold mb-0">Certificate List</h5>
				</div>
							...
							{certificates.length > 0 ? (
								certificates.map((certificate, index) => (
									<tr key={certificate.id || index}>
										...
										<td>{certificate.enrollNumber}</td>
										...
										<td className="text-uppercase">{certificate.location}</td>
