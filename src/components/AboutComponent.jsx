...
const AboutComponent = () => {
	...
	const galleryImages = [
		"/gallery-images/Counselling-1.jpg",
	...
	return (
		<div
			className="about-page bg-light m-0 p-0"
				...
				<section
					...
					<div data-aos="fade-down">
						<img
							...
							style={{ height: "180px" }}
						/>
						<h1 className="display-5 fw-bold text-white mt-4 heading">
							{data.hero.title}
						</h1>
				...
				<section className="about-section container py-5" data-aos="fade-up">
					<div className="row align-items-center gy-4">
						...
						<div className="col-md-4 about-content">
							<h2 className="fw-bold mb-3 heading" style={{ color: "#004aad" }}>
								{data.about.title}
							</h2>
							...
							<div className="mobile-why-wrapper">
								...
								<div className="mobile-girl">
									<img src={data.about.girl} alt="Why choose us" />
								</div>
			...
			{data.features && (
				<section id="services" className="py-5 bg-white" data-aos="fade-up">
					<h3
						className="text-center fw-bold mb-5 heading"
						style={{ color: "#004aad" }}>
						Our Features
					</h3>
