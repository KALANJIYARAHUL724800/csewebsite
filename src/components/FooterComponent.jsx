      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            ...
            <p><i className="bi bi-telephone-fill me-2"></i>+91 9443414067</p>
            <a href='' target="cseramnad@gmail.com" className='text-white text-decoration-none'><i className="bi bi-envelope-fill me-2"></i>cseramnad@gmail.com</a>
