...
const ShowFeesEnquiryComponent = () => {
	...
	const exportExcel = () => {
		...
		enquiryExportExcel(start, end)
			.then((res) => {
				...
				link.setAttribute(
					"download",
					`enquiries_${start}_${end}_${formattedNow}.xlsx`,
				);
	...
	return (
		<div className="container my-5">
			...
			<h3
				className="mb-4 text-center fw-bold heading"
				style={{ color: "#004aad" }}>
				Fees Enquiry List
			</h3>
			...
			<div className="row mb-3 g-2 align-items-end">
				...
				<div className="col-md-3">
					<label
						className="form-label fw-bold heading"
						style={{ color: "#004aad" }}>
						Start Date
					</label>
					<input
					...
					<tbody className="para">
						{filteredData.length > 0 ? (
							...
							<tr>
								<td
									colSpan="6"
									className="text-center text-danger fw-bold para">
									No enquiries found
								</td>
							</tr>
						)}
