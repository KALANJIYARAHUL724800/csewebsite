		...
		<div className="container mt-5">
			{success && (
				<div className="container mt-4">
					<div
						className="alert alert-success alert-dismissible fade show text-center shadow-sm p-3 rounded"
						role="alert">
				...
				<form onSubmit={handleSubmit}>
					<div className="row">
						...
						<div className="col-md-6 mb-3">
							...
							/>
							{errors.joinDate && (
								<div className="text-danger mb-2 para">{errors.joinDate}</div>
							)}
						</div>
						<div className="col-md-6 mb-3">
							...
							/>
							{errors.endDate && (
								<div className="text-danger mb-2 para">{errors.endDate}</div>
							)}
						</div>
						<div className="col-md-6 mb-3">
							...
							{errors.grade && (
								<div className="text-danger mb-2 para">{errors.grade}</div>
							)}
						</div>
						...
						<div className="col-md-6 mb-3">
							...
							{errors.location && (
								<div className="text-danger mb-2 para">{errors.location}</div>
							)}
						</div>
					</div>
