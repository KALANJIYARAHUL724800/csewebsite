			...
			<div className="main-content" id="mainContent">
				...
				<section
					...
					<div data-aos="" className="heading-content">
						...
						<p className="lead text-light para">
				...
				{hasBatches && (
					<section className="available-batches-section">
						<h3 className="available-batches-title">Available Batches</h3>
				...
				<div
					...
					<div className="scene" aria-hidden="true">
						<div className="cube" role="img" aria-label="Animated 3D cube">
							<div className="cube__face face-front">
								<img src="/cselogo.png" className="cube-img img-fluid" />
							</div>
							<div className="cube__face face-back">
								<img src="/cselogo.png" className="cube-img img-fluid" />
							</div>
							<div className="cube__face face-right">
								<img src="/cselogo.png" className="cube-img img-fluid" />
							</div>
							<div className="cube__face face-left">
								<img src="/cselogo.png" className="cube-img img-fluid" />
							</div>
							<div className="cube__face face-top">
								<img src="/cselogo.png" className="cube-img img-fluid" />
							</div>
							<div className="cube__face face-bottom">
								<img src="/cselogo.png" className="cube-img img-fluid" />
							</div>
						</div>
					</div>
				...
				{searched && courses.length > 0 && (
					<div className="container py-5 position-relative" id="courses">
						...
						<h1 className="text-center mb-5 text-primary heading">
							Available Courses
						</h1>
						<div
          ...
          {userLogin && (
            ...
            >
              Student Login
				...
				{/* course section */}
				<h1 className="display-5 fw-bold mt-4 text-primary text-center heading">
					All Courses
				</h1>
				<hr />
